...
**MOS e hap `public/index.html` duke klikuar dy herë mbi të!** Faqja funksionon vetëm kur serveri (`server.js`) është duke punuar - ndryshe do të shfaqet "Nuk lidhet me serverin". Gjithmonë nise nëpërmjet skriptit më poshtë, ose me `npm start`, dhe hape adresën `http://localhost:3000` (jo skedarin direkt).
